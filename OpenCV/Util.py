...
class MercatorProjection:
    ...
    def fromLatLngToPoint(self, latLng, opt_point=None):
        ...
        point.x = origin.x + latLng[1] * self.pixelsPerLonDegree_
        # NOTE(appleton): Truncating to 0.9999 effectively limits latitude to
        # 89.189.  This is about a third of a tile past the edge of the world tile.
        siny = bound(math.sin(degreesToRadians(latLng[0])), -0.9999, 0.9999)
...
def getCorners(center, zoom, mapWidth, mapHeight):
    ...
    return SWLatLon.lng, SWLatLon.lat, NELatLon.lng, NELatLon.lat
