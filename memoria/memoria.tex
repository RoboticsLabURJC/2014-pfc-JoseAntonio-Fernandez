...
\centering{
   \label{f:diseno_uavc_caja_negra}
    \includegraphics[width=0.9\textwidth]{img/diseno2_uavc.jpg}}
...
\centering{
   \label{f:actitud_uavc}
    ...
    \caption{Ventana actitud de \texttt{UAV Commander}}
...
Podemos ver la proyecci\'on de posici\'on geogr\'afica a imagen en la Figura 5.9.
\begin{figure}
\begin{python}
...
Este bloque es el encargado de facilitar la creación y envío de misiones. Ha de permitir crear misiones de forma interactiva además de permitir indentificar y convertir en objetos de interfaz ICE \texttt{mission} las maniobras de despegue y aterrizaje y los puntos de paso.
