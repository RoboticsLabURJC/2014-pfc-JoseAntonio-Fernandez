...
\end{figure}
En la aplicaci\'on \texttt{UAV Commander} se utilizan 5 interfaces ICE a diferencia de los 4 que expon\'ia el driver \texttt{APM Server}. Adem\'as de los que expone \texttt{APM Server}, a saber: \texttt{Pose3D}, \texttt{NavData}, \texttt{Extra} y \texttt{Mission}
Se implementa uno m\'as, el interfaz \texttt{camera}, para regoger las im\'agenes y vídeo que se muestran en la interfaz gráfica.
