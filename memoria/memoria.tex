...
A lo largo del documento se han descrito los objetivos de este Proyecto Fin de Carrera, la plataforma hardware utilizada y la infraestructura software realizada para abordar el problema descrito en el capítulo dos. Se ha detallado el diseño e implementación de todos los desarrollos implementados en este proyecto, \texttt{APM Server} y \texttt{UAV Commander}, y se han validado con sendos experimentos en el cpítulo seis.
El objetivo general de dar soporte en JdeRobot a drones tipo avión, incluyendo misiones como secuencia de puntos de paso se ha cumplido satisfactoriamente, al igual que los 3 subobjetivos definidos en el capítulo dos. 
